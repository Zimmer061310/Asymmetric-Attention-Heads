...
def main():
    ...
    configs = [
        "configs/aah_v3_full_1b_10000_opt_ctrl_baseline.yaml",
        "configs/aah_v3_full_1b_10000_opt_windows_trim3.yaml",
        "configs/aah_v3_full_1b_10000_opt_windows_dense6.yaml",
        "configs/aah_v3_full_1b_10000_opt_interval_200.yaml",
        "configs/aah_v3_full_1b_10000_opt_interval_800.yaml",
        "configs/aah_v3_full_1b_10000_opt_thresh_aggr.yaml",
        "configs/aah_v3_full_1b_10000_opt_thresh_cons.yaml",
        "configs/aah_v3_full_1b_10000_opt_control_off.yaml",
    ]
    ...
    print("AAH-v3 multi-knob sweep completed.", flush=True)
