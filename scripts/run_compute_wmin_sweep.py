...
def main():
    ...
    configs = [
        "configs/aah_v3_full_1b_10000_compute_wmin_64.yaml",
        "configs/aah_v3_full_1b_10000_compute_wmin_96.yaml",
        "configs/aah_v3_full_1b_10000_compute_wmin_128.yaml",
        "configs/aah_v3_full_1b_10000_compute_wmin_160.yaml",
    ]
    ...
    print("Compute W_min sweep completed.", flush=True)
