...
CONFIG="experiments/aah_flops_reduction_lab/h5_head_reorder_candidate/configs/flopslab-4096-headreorder-lowerbound-1024-4096-flash-seed0.yaml"
...
python -m experiments.backend_realized_local_attention._common.profile_gpu_flops_ncu \
  ...
  --output "$ROOT/gpu_flops_profiles/flopslab-4096-headreorder-lowerbound-1024-4096-flash-seed0_gpu_flops_profile.json"
...
python -m experiments.backend_realized_local_attention._common.profile_gpu_flops_ncu \
  ...
  --output "$ROOT/gpu_flops_profiles/flopslab-4096-headreorder-lowerbound-1024-4096-flash-seed0_attention_gpu_flops_profile.json"
